...
public class Spawner : MonoBehaviour
{
    ...
    private void FixedUpdate() 
    {
        ...
        if(objectSpawn<0 && spawnCount<4 && checkHitOnBox.stop == true)
        {
            ...
            Vector3 randomSpawnPosition=new Vector3(Random.Range(cameraTransform.x-5,cameraTransform.x+5),cameraTransform.y-1,cameraTransform.z+5);//change range to reference the cameras current position.
